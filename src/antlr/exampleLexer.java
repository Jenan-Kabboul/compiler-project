// Generated from C:/Users/Jenan/Desktop/Compiler_project-main/Compiler_project-main/grammars/exampleLexer.g4 by ANTLR 4.13.2
package antlr;
...
public class exampleLexer extends Lexer {
	...
	public Vocabulary getVocabulary() {
	    ...
	    Token commonToken(int type, String text) {
	        ...
	        // 2. إنشاء التوكن. استخدمنا 0 كرمز للقناة الا�?تراضية (DEFAULT_CHANNEL)
	    ...
	    public Token nextToken() {
	        ...
	        if (_mode == Lexer.DEFAULT_MODE) {
	            // 3. معالجة الأسطر الجديدة للمسا�?ات البادئة (INDENT/DEDENT)
	            if (next.getType() == NEWLINE) {
	                ...
	                tokens.add(next); // إضا�?ة NEWLINE دائماً
